...
_CONFIGS = [
    ...
    TrainConfig(
        # RICL with action interpolation on data_v4 (12 tasks, N=25)
        # For C1 comparison: RICL with interp should also underperform baseline in within-task setting
        name="pi0_fast_rlbench_ricl_v4_with_interp",
